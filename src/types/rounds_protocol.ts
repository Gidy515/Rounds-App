 ...
 * IDL can be found at `target/idl/rounds_protocol.json`.
 */
export type RoundsProtocol = {
  "address": "7BBvnkQ4AKMFU6EfWvScSqi69eu9TjLoDzpmzG8ZeFhN",
  "metadata": {
    "name": "roundsProtocol",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "defaulterCollateralRecord",
          "docs": [
  ...
  "errors": [
    ...
    {
      "code": 6011,
      "name": "circleAlreadyCancelled",
      "msg": "This circle has already been cancelled."
    },
    {
      "code": 6012,
      "name": "cancelWindowNotPassed",
